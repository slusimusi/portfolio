...
![Choosing Money in/out](@site/static/img/step-1.png)

## 2. Choose the "Mobile TopUp" option

In the "Money in/out" page, click on "Mobile TopUp".
![Choosing Mobile TopUp](@site/static/img/step-2.png)
